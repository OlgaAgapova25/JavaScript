...
console.log(`The result is ${Math.pow(number,3)}`)
...
(typeof(salary) == Number) ? console.log(`Размер заработной платы за вычетом налогов равен ${salary*0,87}`) : console.log("You've entered a string not a number")
...
if (num1 > num2){
    ...
    if (num2 > num3){
        console.log(`The result is ${num2}`);
    } else {
        console.log(`The result is ${num3}`);
    }
}

...
let day = 30
console.log(`The date is in the ${parseInt(day/10)+1} decade`)
...
numberInit = number;
let firstGrade = number%10;
number = parseInt(number/10);
let secondGrade = number%10;
number = parseInt(number/10);
console.log(`В числе ${numberInit} количество сотен: ${number}, десятков: ${secondGrade}, единиц: ${firstGrade}`);
